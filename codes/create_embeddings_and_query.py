...
def teaser_pipeline(method, audio_data=None, visual_data=None, query_audio_text="best sentence for teaser", query_visual_text="best visuals for teaser"):
    ...
    return formatted_audio, formatted_visual
...
if __name__ == "__main__":
    ...
    # Learning Method A
    #audio_res, visual_res = teaser_pipeline("learning_a", audio_data=audio_data)
    #print("Learning Method A - Audio Results:", audio_res)
    #print("Learning Method A - Visual Results:", visual_res)

    # Learning Method B
    audio_res, visual_res = teaser_pipeline("learning_b", audio_data=audio_data, visual_data=visual_data)
    print("Learning Method B - Audio Results:", audio_res)
    print("Learning Method B - Visual Results:", visual_res)
    total_length= len(visual_res)*1.5 
    print(total_length)

    # Cinematic Method A

    #audio_res, visual_res = teaser_pipeline("cinematic_a", audio_data=audio_data, visual_data=visual_data)
    #print("Cinematic Method A - Audio Results:", audio_res)
    #print("Cinematic Method A - Visual Results:", visual_res)
