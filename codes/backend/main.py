...
from gemini_for_timestamps import generate_timestamps_with_gemini  # Import the new function
...
def process_video_to_teaser(input_source, max_length=70, min_length=60, is_youtube=True, method="learning_b", output_dir=OUTPUT_DIR):
    ...
    # Handle gemini method differently
    if method == "gemini":
...
# Generate timestamps using Gemini - CAPTURE BOTH RETURN VALUES
        ...
        # Skip to creating the final teaser
        ...
        result = crop_and_merge_clips_ffmpeg(
            ...
            method=method,
            external_audio_path=None  # No voiceover for gemini method
        )
    else:
        # Existing workflow for other methods
